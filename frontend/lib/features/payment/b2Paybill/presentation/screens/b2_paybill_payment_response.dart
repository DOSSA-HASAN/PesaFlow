...
class B2PaybillPaymentResponse extends ConsumerStatefulWidget {
  const B2PaybillPaymentResponse({super.key});

  ConsumerState<B2PaybillPaymentResponse> createState() => _B2PaybillPaymentResponseState();
}

class _B2PaybillPaymentResponseState extends ConsumerState<B2PaybillPaymentResponse>{

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final callbackState = ref.watch(b2PaybillCallbackProvider);
